...
<div style="position: fixed; top: 0px; width: 100%; z-index: 30;" class="bg-indigo-darker text-center p-4 px-6 flex items-center">
    ...
    <div class="flex flex-grow items-center lg:w-3/4 xl:w-4/5">
        ...
        <a href="#" class="text-sm text-right text-white py-2 px-3 hover:text-grey-dark no-underline hidden lg:block lg:w-1/3 px-6">个 人 中 心</a>
    </div>
</div>
<!-- Main -->
<div class="flex">
        ...
        <ul class="list-reset mb-8 w-full">
            ...
            <li class="ml-2 mb-4">
                ...
                <ul class="text-grey lg:text-grey-dark list-reset leading-loose mt-2" id="sidenav-categories">
                    <li class="hover:text-indigo-dark hover:cursor-pointer transition-normal ml-1 border-l border-grey-dark pl-4">文学艺术</li>
                    <li class="hover:text-indigo-dark hover:cursor-pointer transition-normal ml-1 border-l border-grey-dark pl-4">人文社科</li>
                    <li class="hover:text-indigo-dark hover:cursor-pointer transition-normal ml-1 border-l border-grey-dark pl-4">经管励志</li>
                    <li class="hover:text-indigo-dark hover:cursor-pointer transition-normal ml-1 border-l border-grey-dark pl-4">健康生活</li>
                    ...
                    <li class="hover:text-indigo-dark hover:cursor-pointer transition-normal ml-1 border-l border-grey-dark pl-4">教育学习</li>
                </ul>
            </li>
            <li class="ml-2 mb-4 flex">
    ...
    <div style="margin-top: 50px;" class="flex flex-1 flex-col md:px-6 pt-10" id="content">
        ...
        <div class="hidden px-6 md:px-0 mt-4 md:flex flex-wrap order-1 md:-order-1 md:shadow-md js-tab-pane" id="section-stats">
            <div class="p-4 px-6 w-full md:w-1/2 rounded md:rounded-r-none bg-white shadow-md md:shadow-none">
                ...
                <table class="mt-4 w-full">
                    ...
                    <tr class="border-b">
                        <td class="py-2 text-center">Yohji Yamamoto</td>
                        <td class="py-2 text-center">5/4</td>
                        <td class="py-2 text-center">Japan</td>
                        <td class="py-2 text-center">最喜欢的书籍</td>
                    </tr>
                    <tr class="border-b">
                        <td class="py-2 text-center">Yohji Yamamoto</td>
                        <td class="py-2 text-center">5/4</td>
        ...
        <div class="px-6 md:px-0 flex items-baseline justify-between border-b-2 border-grey-light mt-6 order-0 lg:order-1">
            <h4 class="hidden md:inline-block text-grey-dark font-normal">图书</h4>
        </div>
        <div>
            <div class="px-6 md:px-0 flex items-baseline justify-between border-b-2 border-grey-light mt-6 order-0 lg:order-1">
        ...
        <div class="mt-6">
            ...
            <div class="flex items-start mt-2">
                <img style="width: 80px" src="${pageContext.request.contextPath}/images/books/${reading.bno}.jpg" alt="read" class="w-1/6 lg:w-1/5 max-w-tiny shadow-md block transition-normal hover:brighter">
                    <div class="ml-3">
                        <p class="mt-1 leading-normal"><a href="#" style="text-decoration: none; color: #706a71;font-size: 18px" >${readingbook.bname}</a></p>
